...
namespace Completed
{
	...
	public class Player : MovingObject
	{
		...
		public TwoAnswer answerTwoScript;
		public ChangeScene changeScene;
		public GameObject Answer2Board;
		...
		private void OnTriggerEnter2D (Collider2D other)
		{
			...
			if (other.tag == "Exit1") {
				...
				if (currentInterObjScript.openable) {
					if (currentInterObjScript.locked) {
						if (LevelToLoad == "Level 2" || answerScript.FoundAnswer (answerScript.rightAnswer) || (answerTwoScript.FoundTwoAnswer (answerTwoScript.rightAnswerTwo, answerTwoScript.rightAnswerOne))) {
							Debug.Log ("dooor");
							...
							food -= pointsPerFood;
							foodText.text = "POWER - " + pointsPerFood;
			...
			//Check if the tag of the trigger collided with is Food.
				...
				currentInterObj = other.gameObject;
				currentInterObjScript = currentInterObj.GetComponent<InteractionObject> ();
				pinventory.AddItem (currentInterObj);
				other.gameObject.SetActive (false);
				...
				currentInterObjScript = currentInterObj.GetComponent<InteractionObject> ();
				Debug.Log ("a");
				Answer2Board.gameObject.SetActive (true);

			} else if (other.tag == "Computer2") {
				currentInterObj = other.gameObject;
				currentInterObjScript = currentInterObj.GetComponent<InteractionObject> ();
				Debug.Log ("abbbb");
